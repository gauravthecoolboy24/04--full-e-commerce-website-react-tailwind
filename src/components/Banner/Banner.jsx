            ...
            <div className="container">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 items-center">
                    ...
                    <div data-aos="zoom-in">
                        <img src={BannerImg} alt="" className='max-w-[420px] h-[310px] w-full mx-auto object-cover drop-shadow-[-10px_10px_12px_rgba(0,0,0,0.8)]' />
                    </div>
                    ...
                    <div className='flex flex-col justify-center gap-6 sm:pt-0 text-xl font-semibold px-2 sm:px-0 '>
                        ...
                        <p data-aos="fade-up" className='text-sm tracking-wider leading-5 text-gray-400 '>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Eaque reiciendis inventore iste ratione ex alias quis magni at optio</p>
